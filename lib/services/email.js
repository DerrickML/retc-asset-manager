...
export class EmailService {
  ...
  static async sendRequestDenied(request, requester, asset, approver) {
    const denialReason = request.status === ENUMS.REQUEST_STATUS.DENIED 
      ? (extractDenialReason(request.purpose) || request.denialReason || request.approval_notes || request.notes || "No reason provided")
      : (request.denialReason || request.approval_notes || "No reason provided");
